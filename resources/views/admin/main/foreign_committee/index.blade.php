                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('foreign.create') }}" class="btn btn-primary btn-sm"> <i
                                        class="ph ph-plus"></i>
                                    নতুন সদস্য</a>
                            </div>
                        </div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a class="btn btn-secondary btn-sm me-2"
                                                            href="{{ route('foreign.show', $item->id) }}"><i
                                                                class="ph ph-eye"></i> দেখুন</a>
                                                        <a class="btn btn-info btn-sm me-2"
                                                            href="{{ route('foreign.edit', $item->id) }}"><i
                                                                class="ph ph-pencil"></i> এডিট</a>
                                                        <form class="deleteForm"
                                                            action="{{ route('foreign.destroy', $item->id) }}"
                                                            method="post">
                                                            @csrf
                                                            <button type="button"
