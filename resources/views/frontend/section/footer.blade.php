...
<footer
    class="et-footer bg-etBlack relative z-[1] before:absolute before:-z-[1] before:inset-0 before:opacity-30 before:mix-blend-overlay text-white"
    ...
    <div
            ...
            <div class="bg-etBlue py-[35px] px-[40px] xl:px-[30px] rounded-[20px] mb-[60px] overflow-hidden relative z-[1] flex lg:flex-wrap justify-between lg:justify-center xs:justify-start items-center gap-[20px] before:absolute before:-z-[1] before:inset-0 before:opacity-40 before:mix-blend-multiply"
                ...
                <div class="flex xxs:flex-col items-center xxs:items-start gap-[15px] xxs:gap-[10px]">
                    ...
                    @if (isset($setting))
                        <!-- txt -->
                        <div>
                            <span class="block font-medium text-[14px]">ইমেইল</span>
                            <h5 class="font-medium text-[20px]"><a
                                    href="mailto:{{ $setting->business_email }}">{{ $setting->business_email }}</a></h5>
                        </div>
                </div>
            ...
            <div
                ...
                <div class="et-footer-about max-w-[295px] lg:max-w-none md:max-w-[300px] xs:max-w-full">
                    @if (isset($setting->logo))
                        <a href="{{ route('home') }}" class="mb-[25px] inline-block"><img
                                src="{{ asset('storage/' . $setting->logo) }}" alt="logo"></a>
                    @else
                        <a href="{{ route('home') }}" class="mb-[25px] inline-block"><img
                                src="{{ asset('frontend/img/logo-white.png') }}" alt="logo"></a>
                    @endif
                    <p class="font-light text-[#f2f2f2] text-[16px] mb-[25px]">আপনার আমার একটু প্রচেষ্টা হাসি ফুটাবে
                        অসহায় মানুষদের মুখে ইনশাআল্লাহ!</p>
                    ...
                    <div
                        ...
                        <a href="https://m.facebook.com/groups/ProtectYourCommunity/?ref=share&mibextid=NSMWBT"
                            class="hover:text-white hover:bg-etBlue hover:border-etBlue"><i
                                class="fa-brands fa-facebook-f"></i></a>
                        <a href="https://wa.me/{{ $setting->business_whatsapp }}"
                            class="hover:text-white hover:bg-etBlue hover:border-etBlue"
                            onclick="window.open('https://wa.me/{{ $setting->business_whatsapp }}', '_blank');"> <i
                ...
                <div class="et-footer-widget shrink-0 xs:grow">
                    <h5 class="text-[20px] font-semibold mb-[16px]">প্রয়োজনীয় <span class="text-etBlue">লিঙ্কসমূহ</span>
                    </h5>
                    ...
                    <ul class="space-y-[17px] text-[16px] font-light text-[#f2f2f2]">
                        ...
                        <li>
                            <a href="{{ route('all.foreign') }}"
                                ...
                                <span class="txt">প্রবাসী পরিষদ</span>
                            </a>
                        </li>
                        {{-- <li>
        ...
        <div class="et-footer-bottom border-t border-white/20 py-[34px]">
            <p class="font-light text-[#f2f2f2] text-center text-[16px]">&copy; ২০২৪, <a class="text-etBlue"
                    href="https://eftakharmahmud.com">সৈকত মাহমুদ</a> সর্বস্বত্ব সংরক্ষিত।</p>
        </div>
    </div>
</footer>
<!-- FOOTER SECTION END -->
