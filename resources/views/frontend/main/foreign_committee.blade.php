...
@section('content')
    ...
    <section
        ...
        <div class="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full text-center text-white">
            <h1 class="et-breadcrumb-title font-medium text-[56px] md:text-[50px] xs:text-[45px]">প্রবাসী পরিষদ</h1>
            <ul class="inline-flex items-center gap-[10px] font-medium text-[16px]">
                <li class="opacity-80"><a href="{{ route('home') }}" class="hover:text-etBlue">হোম</a></li>
                <li><i class="fa-solid fa-angle-right"></i><i class="fa-solid fa-angle-right"></i></li>
                <li class="current-page">প্রবাসী পরিষদ</li>
            </ul>
        </div>
    </section>
    ...
    <div class="py-[130px] xl:py-[80px] md:py-[60px] mx-[25px]">
        ...
        @else
            <div class="flex flex-col justify-center items-center">
                <h3 class="text-center text-[2.4rem] text-[#757277]">কোনো প্রবাসী পরিষদ সদস্য পাওয়া যায়নি!</h3>
