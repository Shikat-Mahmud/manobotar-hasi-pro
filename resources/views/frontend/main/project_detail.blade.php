        ...
        <div class="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
            <div class=" gap-[30px] lg:gap-[20px] md:flex-col md:items-center">
                ...
                <div class="left">
                    ...
                    @if (isset($project->project_photos) && count($project->project_photos) > 0)
                        <div
                            ...
                            <div class="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
                                ...
                                <div
                                    ...
                                    <div class="left xs:text-center">
                                        <h4 class="text-[30px] xs:text-[20px] xxs:text-[20px] text-etBlack">
                    ...
                    @if (isset($otherProjects) && $otherProjects->count() > 0)
                        <div class="mb-[50px] mt-[50px]">
                            ...
                            <div class="p-[20px] lg:p-[20px] flex flex-wrap sm:justify-center gap-x-[30px] gap-y-[30px] mb-[30px]"
                                                ...
                                                <div class="overflow-hidden rounded-[6px]">
                                                    ...
                                                    @else
                                                        <img src="{{ asset('frontend/img/team_member_avatar.jpg') }}"
                                                            alt="Default Image"
                                                            class="rounded-[6px] w-[180px] aspect-square">
                                                    @endif
                                                </div>
